...
REFERAT = block([
    ...
    P("Основные результаты. Предложен метод JointAdaSpec, формализующий совместное "
      ...
      "потенциал адаптивного управления (+4,07 п.п. exact match, p = 0,0205, n = 1500; "
...
def razdel4(figs):
    ...
    P("В артефактах thesis snapshot совместная политика повышает точность на +4,07 п.п. "
      "относительно прямой генерации (p = 0,0205, 95 %-й доверительный интервал "
...
ZAKL = block([
    ...
    P("Предложенный метод JointAdaSpec формализует выбор пары (длина черновика, порог "
      ...
      "метода: +4,07 п.п. exact match относительно прямой генерации (p = 0,0205 по парному "
